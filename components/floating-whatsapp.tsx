...
export function FloatingWhatsapp() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl shadow-black/20 transition-transform hover:scale-110 sm:h-16 sm:w-16"
    >
      {/* Pulse */}
      <span
        ...
        aria-hidden="true"
      />
      {/* Icon (inline SVG, no extra icon pkg needed) */}
      <svg
        viewBox="0 0 24 24"
